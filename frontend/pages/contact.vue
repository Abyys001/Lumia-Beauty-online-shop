        ...
        <div class="grid grid-cols-1 sm:grid-cols-3 gap-6">
          <div class="flex items-start gap-3">
            ...
            <div>
              ...
              <p class="text-xs text-base-content/70 mt-1 dir-ltr text-right">۰۲۱-۲۲۶۶۰۱۲۰</p>
              <p class="text-xs text-base-content/70 mt-0.5 dir-ltr text-right">۰۹۱۲-۱۱۱۱۱۱۱</p>
            </div>
          </div>
          <div class="flex items-start gap-3">
            <span class="text-xl mt-0.5" aria-hidden="true">⏰</span>
...
useSeoMeta({
  ...
  description: 'ارتباط با لومیا بیوتی از طریق واتس‌اپ، تلگرام و اینستاگرام. مشاوره رایگان انتخاب عطر و روتین پوست.',
})
</script>
