...
urlpatterns = [
    ...
    path('products/<str:slug>/related/', RelatedProductsView.as_view(), name='product-related'),
    path('products/<str:slug>/reviews/', ProductReviewCreateView.as_view(), name='product-review'),
